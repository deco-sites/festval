      ...
      <div id={id} class="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-[min-content_1fr] gap-5">
        ...
        <div class="col-start-1 col-span-1 sm:col-start-2">
          <div class="relative  h-min flex-grow">
            ...
            <Slider.PrevButton
              class="no-animation absolute left-2 top-1/2 btn btn-circle hover:bg-transparent border-none shadow-inherit hover:opacity-80 hover:border-none bg-transparent disabled:invisible"
              disabled
            >
            ...
            <Slider.NextButton
              class="no-animation absolute right-2 top-1/2 btn btn-circle hover:bg-transparent border-none shadow-inherit hover:opacity-80 hover:border-none bg-transparent disabled:invisible"
