...
export default function GallerySlider(props: Props) {
  ...
  return (
    <>
      <div
        id={id}
        class="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-[min-content_1fr] "
      >
        {/* Image Slider */}
          ...
          <div class="relative  h-min flex-grow">
            <Slider class="carousel carousel-center gap-6 w-full">
              {images.map((img, index) => (
                <Slider.Item
                  index={index}
                  class="carousel-item justify-center w-full"
                >
                  <Image
            ...
            <ul
              class={clx(
                "col-span-full absolute -bottom-2  inset-x-0 z-10",
