  ...
  return (
    <>
      <div className="relative w-full max-w-sm">
        ...
        <select
          name="sort"
          class=" w-fit  text-base py-2 rounded-none flex items-center justify-center  lg:m-2  cursor-pointer outline-none text-[#282828] bg-trasparent border-none lg:text-xs leading-normal tracking-one  lg:px-2"
