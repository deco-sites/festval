  ...
  return (
    <>
      <div className="relative w-full max-w-sm">
        ...
        <select
          name="sort"
          class=" w-fit  lg:text-base py-2 rounded-none flex items-center justify-center  lg:m-2  cursor-pointer outline-none text-[#282828] bg-trasparent border-none text-sm leading-normal  lg:px-2"
